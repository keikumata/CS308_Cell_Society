...
public class Infinite {
	...
	public Infinite(int[][] matrix, HashMap<Pair, Integer> cells, int xDt, int yDt) {
		...
		// we assume top left square is (0, 0) and bottom right square is (row, col) - this shouldnt matter.
